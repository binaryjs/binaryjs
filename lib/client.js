...
util.inherits(BinaryClient, events.EventEmitter);
...
BinaryClient.prototype._receiveStream = function(streamId){
  var binaryStream = new BinaryStream(this.socket, streamId, false);
...
BinaryClient.prototype.createStream = function(meta){
  ...
  this._nextId += 2;
  var binaryStream = new BinaryStream(this.socket, streamId, true, meta);
  this._streams[streamId] = binaryStream;
  return binaryStream;
};

BinaryStream.prototype.close = BinaryStream.prototype.destroySoon = function(code, message) {
